...
/tmp/pytest-of-root/pytest-35/test_pipeline0/samples/Sample1_R1.fastq.gz,\
/tmp/pytest-of-root/pytest-35/test_pipeline0/samples/Sample1_R2.fastq.gz \
$BIFROST_PIPELINE_TOOLS/bifrost-min_read_check_2.0.7.sif \
-id 5f22b136386df7a40347de70;
singularity run -B \
$BIFROST_RAW_DATA_MNT,\
/tmp/pytest-of-root/pytest-35/test_pipeline0/samples/Sample1_R1.fastq.gz,\
/tmp/pytest-of-root/pytest-35/test_pipeline0/samples/Sample1_R2.fastq.gz \
