...
do
	...
	SAMPLE_PIPELINE_ID=$(submit_sample_component_to_singularity $SAMPLE $PIPELINE $SAMPLE_PIPELINE_ID $sample.name $sample.categories.paired_reads.summary.data[0] $sample.categories.paired_reads.summary.data[1]);
    else
